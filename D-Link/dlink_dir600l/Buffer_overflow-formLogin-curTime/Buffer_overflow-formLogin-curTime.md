# d-link DIR-600L has  buffer overflow vulnerability  in formLogin
...
![code1](Buffer_overflow-formLogin-curTime.assets\code1.png)

![code2](Buffer_overflow-formLogin-curTime.assets\code2.png)
