# d-link DIR-605L has  buffer overflow vulnerability  in formSetWanDhcpplus
...
![code1](Buffer_overflow-formSetWanDhcpplus-curTime.assets\code1.png)

![code2](Buffer_overflow-formSetWanDhcpplus-curTime.assets\code2.png)
