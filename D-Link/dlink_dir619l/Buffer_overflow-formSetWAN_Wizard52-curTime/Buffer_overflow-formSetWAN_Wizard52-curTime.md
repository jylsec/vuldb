# d-link DIR-619L has  buffer overflow vulnerability  in formSetWAN_Wizard52
...
![code1](Buffer_overflow-formSetWAN_Wizard52-curTime.assets\code1.png)

![code2](Buffer_overflow-formSetWAN_Wizard52-curTime.assets\code2.png)
